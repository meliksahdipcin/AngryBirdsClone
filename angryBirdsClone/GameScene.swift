...
//  angryBirdsClone
//
//  Created by Melikşah on 24.08.2019.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        bird2.position = CGPoint(x: -self.frame.width / 5, y: self.frame.height / 10)
        bird2.size = CGSize(width: 0, height: 0)
        bird2.zPosition = 1
        self.addChild(bird2)
 */
        ...
        bird.physicsBody = SKPhysicsBody(circleOfRadius: birdTexture.size().height / 8.5)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        /*
        bird.physicsBody?.applyImpulse(CGVector.init(dx: 50, dy: 100))
